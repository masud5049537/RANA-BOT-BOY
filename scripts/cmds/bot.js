    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu") || body.startsWith("বট") || body.startsWith("জান") || body.startsWith("জানু") || body.startsWith("বাবু")) {
            ...
            const rawReplies = [
              ...
              "•আমার বস রানার মন খারাপ 🥺",
              "তুই কি Wi-Fi? কাছে এলেই কানেকশন হারায়া ফেলি 😵",
              "Hmm bolo 🐹",
              "•বট বট না করে আমার বস 𝐑𝐚𝐧𝐚 রে মেসেজ দে 🐸",
              ...
              "I am here 💅",
              "Hi 🙃",
              "hae bolo Jan pakhi 🎀✨","»⑅⃝😽Rana Boss Ke Ummah de»⑅⃝💚🪽"," Gruper Shob Bedire Ummmmah🙈🙈","Bolen Khachorer dol /🫡",
              "হ্যাঁ টুনটুনি বলো 🤭","আমি তোরে সাহায্য করতে পারবো না কারণ তুই অনেক পচা!!😬","_আমাকে না ডেকে আমার বস Rana কে ডাক দে😝","আমাকে এত ডাকিস কেন!🐥","hae bolo Jan pakhi","হুম বলো না বাবু 🥺","𖠣꙰ٜٜٜٜٜٜٜٜٜ̋̀̋̀̋̀̋̀̋̀̋̀⚀ค้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้ـٰٖٖٖٖٖٜ۬ـٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٜ۬ـٰٰٰٰٰٖٜ۬𝐀𝐬𝐬𝐚𝐥𝐚𝐦𝐮𝐚𝐥𝐢𝐤𝐨𝐦ـٰٖٖٖٖٖٜ۬ـٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٜ۬ـٰٰٰٰٰٖٜ۬ค้้้้้้้้้้้้้้้้้้้­้้้้้้้้้้้้้้้้้้้้­้้้้้้้้𖠣꙰ٜٜٜٜٜٜٜٜٜ̋̀̋","•⎯͢⎯⃝ꪜ🩷🪽 𝙸 𝙻𝚘𝚟𝚎 𝚄 . আ্ঁল্লা্ঁহ্ঁ⎯͢⎯⃝🍒 ই্ঁউ্ঁ⎯͢লা্ঁভ্ঁ⎯⃝মি্ঁ😌 ⎯͢⎯⃝🌺","•⎯͢⎯⃝ꪜ🩷চুৃ্ঁপৃ্ঁ•⎯͢°ꪜচা্ঁপৃ্ঁ😾🪽 𝙸 𝙻𝚘𝚟𝚎 𝚄 .ক্ঁ ⎯͢⎯⃝🍒 নৃ্ঁয়ৃ্ঁতোৃ্ঁ⎯͢⎯͢উ্ঁস্টা্ঁ⎯⃝দিৃ্ঁমুৃ্ঁ🍒 ⎯͢⎯⃝😹","amar boss ranar bow nai re kew hoba🤣"," 𝐑𝐚𝐤𝐢𝐛 𝐊𝐞 𝐁𝐨𝐥𝐨 𝐀𝐦𝐢 𝐤𝐚𝐫 "," 𝐎𝐢𝐢 𝐛𝐛𝐲 𝐀𝐦𝐚𝐤𝐞 𝐛𝐢𝐲𝐞 𝐤𝐨𝐫𝐛𝐚","𝐉𝐚𝐧 𝐓𝐮𝐦𝐢 𝐀𝐫 𝐀𝐦𝐢 𝐀𝐥𝐥𝐚𝐡 𝐤𝐞 𝐝𝐚𝐤𝐢.𝐜𝐡𝐨𝐥𝐨 "," 𝐀𝐥𝐥𝐚𝐡 𝐊𝐞 𝐕𝐨𝐲 𝐤𝐨𝐫𝐨","»⑅⃝😽হা্ঁস্ঁবি্ঁ আ্ঁল্লা্ঁহ্ঁ»⑅⃝💚🪽","𝄟≛⃝💚তা্ঁও্ঁয়া্ঁক্কা্ঁল্ঁতু্ঁ আ্ঁলা্ঁল্লা্ঁহ্ঁ༎𝄟≛⃝🌻","⎯͢⎯⃝🌚 স্ঁব্ঁ ক্ঁয়্ঁটা্ঁ শ্ঁয়্ঁতা্ঁন্ঁ ত্ঁরা্ঁ⎯͢⎯⃝🙂🐸","এঁকঁ།কিঁত্বঁ খুঁবঁ 𝐒𝘂n͜͡𝐃𝗼𝗿🌷🍒🪽","⎯͢⎯⃝🌚 স্ঁব্ঁ ক্ঁয়্ঁটা্ঁ শ্ঁয়্ঁতা্ঁন্ঁ ত্ঁরা্ঁ⎯͢⎯⃝🙂🐸","এঁকঁ།কিঁত্বঁ খুঁবঁ 𝐒𝘂n͜͡𝐃𝗼𝗿🌷🍒🪽","হালাল উপার্জন শ্রেষ্ঠ অর্জন!-🌸💚","➺༊ 𝐌𝐚 ♡-ম།নে'ই জ།ন্ন།ত'❯—͟͟͞͞🫶","🫦≛⃝͢➻༏༏বিরাট ভদ্র ছেরি♡⏤͟͟͞͞ ⃝ 🫶Ranar bow ","༺ বাড়াইলি মনেরি জ্বালা ༻","༺/ঘটক বুঝি আমার বাড়ির রাস্তা চিনে না👀😒  ༻","✿⃟✿⃟    মাঁ'য়েঁরঁ দোঁয়াঁই সেঁরাঁ'-!!❤️🤲✿⃟🤗✿⃟❤️","🫵🌚 ও্ঁয়ে্ঁল্ঁ খা্ঁম্ঁ ভ্ঁন্ডি্ঁ —͟͟͞͞𖣘🐸♡»̶̶͓͓͓̽̽̽ ⑅⃝💝","____𝐍𝐞𝐞𝐃 - 𝐁𝐚𝐒𝐭'𝐄 ` 𝐗𝐚𝐧` (🐰🐭",
